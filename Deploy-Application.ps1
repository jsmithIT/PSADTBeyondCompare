...
Try {
	...
	[string]$appVendor = 'Scooter Software'
	[string]$appName = 'Beyond Compare'
	[string]$appVersion = '4.4.1.26165'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.1'
	[string]$appScriptDate = '2022.09.06'
	...
	$CloseApps = "BCompare=Beyond Compare"

	##* Application install parameters.
	# 64-bit application
	# Application install Path.
	$64bitAppInstallPath = "$PSScriptRoot\Files\BCompare-4.4.1.26165.exe"
	# Application  install parameters.
	$64bitAppInstallParam = "/SP- /VERYSILENT /NORESTART" 
	...
	#$RemoveAppNamesMSI = @("")
	$RemoveAppNamesEXE = @("Beyond Compare")

	##* Application uninstall parameters.
	# 64-bit application
	# Application uninstall path.
	$64bitAppUninstallPath = "$Env:Programfiles\Beyond Compare 4\unins000.exe"
	# Application uninstall parameters.
	$64bitAppUninstallParam = "/VERYSILENT /NORESTART"
